...
// -------------------- إتمام الطلب: يوجّه العميل لصفحة فيسبوك للطلب --------------------
// عدّل الرابط بالأسفل إذا غيّرت صفحتك على فيسبوك لاحقًا
const FACEBOOK_PAGE_URL = "https://www.facebook.com/share/1CzZMgSEaT/";
...
checkoutBtn.addEventListener("click", () => {
  ...
  showToast("جارٍ تحويلك لصفحتنا على فيسبوك لإتمام الطلب...");
  setTimeout(() => {
